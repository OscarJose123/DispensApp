...
<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<h4 class="page-header">Registro de Pedido</h4>
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<label class="col-sm-2 control-label">Numero de Pedido</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="numero pedido" data-toggle="tooltip" data-placement="bottom" title="Digite el número del pedido">
						</div>
...
<!-- 						</div> -->
 						...
 						<div class="col-sm-4" data-toggle="tooltip" data-placement="top" title="seleccione el proveedor"> 							<select id="s3_with_tag" > 
...
<!-- 					</div> -->
					<div class="form-group has-error has-feedback">
						...
						<div class="col-sm-4">
							<input type="text" id="input_date" class="form-control" placeholder="fecha del pedido a realizar" data-toggle="tooltip" data-placement="top" title="Selecciona la fecha del pedido">
 						...
 						<div class="col-sm-4"> 
 							<input type="text" class="form-control" placeholder="cantidad solicitada" data-toggle="tooltip" data-placement="top" title="ingrese la cantidad solicitada del producto"> 
 						</div> 
 					</div>
